        ...
        <html>
            ...
            <body>
                ...
                <div class="container" id="content">
                    <h4>Challenges</h4>
                    <a class="button button-primary" href="../xhtml/Challenges_application.xhtml">Bewerbung einreichen</a>
                    <a class="button button-primary" id="challenge-button" href="../xhtml/Challenges_addRegistration.xhtml">Challenge ausschreiben</a>
